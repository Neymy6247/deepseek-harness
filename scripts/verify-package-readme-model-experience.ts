...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-message-navigator': { kind: 'none', reason: 'Browser-side UI plugin layer; derives message navigation from the existing Chat snapshot without registering model-facing content.' },
