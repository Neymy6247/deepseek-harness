...
const PLUGINS: readonly (WebBootEntry & { bundlePath: string })[] = [
  ...
  { id: '@deepseek-ai/dsh-client-ui-message-navigator', bundlePath: 'packages/client/ui-message-navigator/lib/client.js', url: '/plugins/ui-message-navigator.js', rev: 'fx', inject: ['@deepseek-ai/dsh-client-ui-conversation'] },
